...
static void Hacl_Hash_Core_SHA2_init_256(uint32_t *s)
{
...
static void Hacl_Hash_Core_SHA2_init_384(uint64_t *s)
{
  for (uint32_t i = (uint32_t)0U; i < (uint32_t)8U; i = i + (uint32_t)1U)
  {
...
static void Hacl_Hash_Core_SHA2_init_512(uint64_t *s)
{
  for (uint32_t i = (uint32_t)0U; i < (uint32_t)8U; i = i + (uint32_t)1U)
  {
...
static void Hacl_Hash_Core_SHA2_pad_384(FStar_UInt128_uint128 len, uint8_t *dst)
{
  uint8_t *dst1 = dst;
  dst1[0U] = (uint8_t)0x80U;
  uint8_t *dst2 = dst + (uint32_t)1U;
...
static void Hacl_Hash_Core_SHA2_pad_512(FStar_UInt128_uint128 len, uint8_t *dst)
{
  uint8_t *dst1 = dst;
  dst1[0U] = (uint8_t)0x80U;
  uint8_t *dst2 = dst + (uint32_t)1U;
...
static void Hacl_Hash_SHA2_update_multi_256(uint32_t *s, uint8_t *blocks, uint32_t n_blocks)
{
...
static void Hacl_Hash_SHA2_update_multi_384(uint64_t *s, uint8_t *blocks, uint32_t n_blocks)
{
  for (uint32_t i = (uint32_t)0U; i < n_blocks; i = i + (uint32_t)1U)
  {
...
static void Hacl_Hash_SHA2_update_multi_512(uint64_t *s, uint8_t *blocks, uint32_t n_blocks)
{
  for (uint32_t i = (uint32_t)0U; i < n_blocks; i = i + (uint32_t)1U)
  {
    uint32_t sz = (uint32_t)128U;
...
static void Hacl_Hash_SHA2_hash_256(uint8_t *input, uint32_t input_len, uint8_t *dst)
{
  uint32_t
  s[8U] =
    {
...
static void Hacl_Hash_SHA2_hash_384(uint8_t *input, uint32_t input_len, uint8_t *dst)
{
  uint64_t
  s[8U] =
    {
...
static void Hacl_Hash_SHA2_hash_512(uint8_t *input, uint32_t input_len, uint8_t *dst)
{
  uint64_t
  s[8U] =
    {
...
static void Hacl_Hash_Core_SHA1_legacy_init(uint32_t *s)
{
...
static void Hacl_Hash_Core_SHA1_legacy_update(uint32_t *h, uint8_t *l)
{
  uint32_t ha = h[0U];
  uint32_t hb = h[1U];
  uint32_t hc = h[2U];
...
static void Hacl_Hash_Core_SHA1_legacy_pad(uint64_t len, uint8_t *dst)
{
  uint8_t *dst1 = dst;
  dst1[0U] = (uint8_t)0x80U;
  uint8_t *dst2 = dst + (uint32_t)1U;
...
static void Hacl_Hash_Core_SHA1_legacy_finish(uint32_t *s, uint8_t *dst)
{
  uint32_t *uu____0 = s;
  for (uint32_t i = (uint32_t)0U; i < (uint32_t)5U; i = i + (uint32_t)1U)
  {
...
static void Hacl_Hash_SHA1_legacy_update_multi(uint32_t *s, uint8_t *blocks, uint32_t n_blocks)
{
  for (uint32_t i = (uint32_t)0U; i < n_blocks; i = i + (uint32_t)1U)
  {
    uint32_t sz = (uint32_t)64U;
...
static void Hacl_Hash_SHA1_legacy_hash(uint8_t *input, uint32_t input_len, uint8_t *dst)
{
  uint32_t
  s[5U] =
    {
...
static uint32_t Hacl_HMAC_DRBG_reseed_interval = (uint32_t)1024U;

static uint32_t Hacl_HMAC_DRBG_max_output_length = (uint32_t)65536U;

static uint32_t Hacl_HMAC_DRBG_max_length = (uint32_t)65536U;

static uint32_t Hacl_HMAC_DRBG_max_personalization_string_length = (uint32_t)65536U;

static uint32_t Hacl_HMAC_DRBG_max_additional_input_length = (uint32_t)65536U;

static uint32_t Hacl_HMAC_DRBG_min_length(Spec_Hash_Definitions_hash_alg a)
{
  switch (a)
  {
    case Spec_Hash_Definitions_SHA1:
...
vectors_low177[28U] =
  {
    {
      .fst = Spec_Hash_Definitions_SHA1, .snd = { .len = (uint32_t)16U, .b = vectors_low0 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA1, .snd = { .len = (uint32_t)16U, .b = vectors_low7 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA1, .snd = { .len = (uint32_t)16U, .b = vectors_low15 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA1, .snd = { .len = (uint32_t)16U, .b = vectors_low20 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA1, .snd = { .len = (uint32_t)16U, .b = vectors_low24 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA1, .snd = { .len = (uint32_t)16U, .b = vectors_low31 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low39 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low46 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low53 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low60 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low68 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low73 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low81 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low88 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_256, .snd = { .len = (uint32_t)32U, .b = vectors_low92 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_384, .snd = { .len = (uint32_t)32U, .b = vectors_low97 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_384, .snd = { .len = (uint32_t)32U, .b = vectors_low104 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_384, .snd = { .len = (uint32_t)32U, .b = vectors_low108 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low115 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low119 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low123 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low128 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low136 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low140 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low147 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low155 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low163 },
    ...
    {
      .fst = Spec_Hash_Definitions_SHA2_512, .snd = { .len = (uint32_t)32U, .b = vectors_low170 },
...
)
{
  ...
  (
    ...
    && Hacl_HMAC_DRBG_min_length(a) <= entropy_input_len
    && entropy_input_len <= Hacl_HMAC_DRBG_max_length
    && Hacl_HMAC_DRBG_min_length(a) / (uint32_t)2U <= nonce_len
    && nonce_len <= Hacl_HMAC_DRBG_max_length
    && personalization_string_len <= Hacl_HMAC_DRBG_max_personalization_string_length
    && Hacl_HMAC_DRBG_min_length(a) <= entropy_input_reseed_len
    && entropy_input_reseed_len <= Hacl_HMAC_DRBG_max_length
    && additional_input_reseed_len <= Hacl_HMAC_DRBG_max_additional_input_length
    && additional_input_1_len <= Hacl_HMAC_DRBG_max_additional_input_length
    && additional_input_2_len <= Hacl_HMAC_DRBG_max_additional_input_length
    && (uint32_t)0U < returned_bits_len
    && returned_bits_len <= Hacl_HMAC_DRBG_max_output_length)
  )
  {
    exit((int32_t)-1);
  }
  else
  {
    ...
    Hacl_HMAC_DRBG_state st = { .k = k1, .v = v1, .reseed_counter = &ctr };
    Hacl_HMAC_DRBG_instantiate(a,
      st,
      entropy_input_len,
      entropy_input,
      nonce_len,
